...
public class Offer11 {
    ...
    public static void main(String[] args) {
        ...
        int[] arr2 = {2, 2, 2, 0, 1};
        int[] arr3 = {1, 1};
        System.out.println(Offer11.minInReversingList(arr1));
        System.out.println(Offer11.minInReversingList(arr2));
        System.out.println(Offer11.minInReversingList(arr3));
    }
